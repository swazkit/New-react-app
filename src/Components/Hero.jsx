...
const Hero = () => (
    <div id='home' className={`overflow-hidden flex md:flex-row flex-col ${styles.paddingY} hide`}>
      ...
      <div>
        ...
        <div className="absolute z-[0] w-[40%] h-[35%] rounded-full top-0 pink__gradient "></div>
        <div className="absolute z-[2] w-[50%] h-[50%] rounded-full right-20 bottom-20 blue__gradient "></div>
      </div>
    </div>
)
